...
write.csv(slf_cal_2017_2018$posterior_means, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2017_2018_means.csv", row.names = FALSE)
write.csv(slf_cal_2017_2018$posterior_cov_matrix, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2017_2018_cov_matrix.csv", row.names = FALSE)
write.csv(slf_cal_2017_2018$total_number_of_observations, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2017_2018_total_observations.csv", row.names = FALSE)
write.csv(slf_cal_2017_2018$raw_calibration_data, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2017_2018_raw_calibration.csv", row.names = FALSE)


infected_years_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/slf2019_infested.tif"
number_of_observations <- 33305
prior_number_of_observations <- slf_cal_2017_2018$total_number_of_observations
prior_means <- slf_cal_2017_2018$posterior_means
prior_cov_matrix <- slf_cal_2017_2018$posterior_cov_matrix
params_to_estimate <- c(T, T, T, T)
number_of_generations <- 8
generation_size <- 1000
checks = c(800, 2000000, 1000, 10000)
infected_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/slf2018_infested.tif"
host_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_6_state_region_psuedo_mercator/tree_of_heaven_0.50.tif"
total_plants_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_6_state_region_psuedo_mercator/total_hosts.tif"
temp <- TRUE
temperature_coefficient_file <- "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_6_state_region_psuedo_mercator/temp_coefficient_slf_2015_2017.tif"
...
slf_cal_2018_2019 <- abc_calibration(infected_years_file, 
                                     number_of_observations, prior_number_of_observations,
                                     prior_means, prior_cov_matrix, params_to_estimate,
                                     number_of_generations,
                                     generation_size,
...
write.csv(slf_cal_2018_2019$posterior_means, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2018_2019_means.csv", row.names = FALSE)
write.csv(slf_cal_2018_2019$posterior_cov_matrix, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2018_2019_cov_matrix.csv", row.names = FALSE)
write.csv(slf_cal_2018_2019$total_number_of_observations, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2018_2019_total_observations.csv", row.names = FALSE)
write.csv(slf_cal_2018_2019$raw_calibration_data, "H:/Shared drives/APHIS  Projects/PoPS/Case Studies/spotted_latternfly/slf_data_redone_with_all_data_sources/calibration and assessment/2018_2019_raw_calibration.csv", row.names = FALSE)
